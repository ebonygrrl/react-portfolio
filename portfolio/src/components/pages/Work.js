    ...
    return (
        ...
        <section id="work" class="sec-wrap">
            ...
            <article class="section-content work">
                ...
                <figure class="sample"><a href="https://www.saybrook.edu/unbound/timeline/" target="_blank"><img src="./assets/images/saybrook-university-50th-anniversary.jpg" alt="Saybrook University timeline screenshot"></a><figcaption>Saybrook University Timeline</figcaption></figure>
            </article>
        </section>
    );
}